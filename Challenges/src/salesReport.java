 ...
 * calculates and displays the total sales and average daily sales.
 */
...
public class salesReport {
	...
	public static double getTotalSales(String filename) throws IOException {
		...
		/*
		 * This loop processes the lines read from the file, until the end of the file
		 * is encountered.
		 */
